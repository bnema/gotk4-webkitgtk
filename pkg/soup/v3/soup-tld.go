...
func init() {
	coreglib.RegisterGValueMarshalers([]coreglib.TypeMarshaler{
		coreglib.TypeMarshaler{T: GTypeTLDError, F: marshalTLDError},
	})
}
...
func marshalTLDError(p uintptr) (interface{}, error) {
	return TLDError(coreglib.ValueFromNative(unsafe.Pointer(p)).Enum()), nil
}
...
//
// The base domain is composed by the top level domain (such as .org,
// .com, .co.uk, etc) plus the second level domain, for example for
...
// arbitrary.
//
// Prior to libsoup 2.46, this function required that hostname be in UTF-8 if
// it was an IDN. From 2.46 on, the name can be in either UTF-8 or ASCII format
