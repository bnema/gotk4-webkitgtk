...
// CookiesFromResponse parses msg's Set-Cookie response headers and returns
// a List of Cookie<!-- -->s. Cookies that do not specify "path" or "domain"
...
// SetMaxAge sets cookie's max age to max_age. If max_age is -1, the cookie
// is a session cookie, and will expire at the end of the client's session.
