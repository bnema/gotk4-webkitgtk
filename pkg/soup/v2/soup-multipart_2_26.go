...
// Multipart represents a multipart HTTP message body, parsed
// according to the syntax of RFC 2046. Of particular interest
// to HTTP are <literal>multipart/byte-ranges</literal> and
...
// using "Content-Disposition: form-data", as per the HTML forms specification.
// See soup_form_request_new_from_multipart() for more details.
//
