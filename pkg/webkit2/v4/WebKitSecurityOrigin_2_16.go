...
// IsOpaque: this function returns FALSE.
//
// This function returns FALSE. KitSecurityOrigin is now a simple wrapper around
// a <protocol, host, port> triplet, and no longer represents an origin as
// defined by web standards that may be opaque.
//
