...
func (notification *Notification) ConnectClicked(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(notification, "clicked", false, unsafe.Pointer(C._gotk4_webkit24_Notification_ConnectClicked), f)
}
...
func (notification *Notification) ConnectClosed(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(notification, "closed", false, unsafe.Pointer(C._gotk4_webkit24_Notification_ConnectClosed), f)
}
