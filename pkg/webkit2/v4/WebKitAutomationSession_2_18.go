...
// extern void _gotk4_webkit24_AutomationSession_ConnectWillClose(gpointer, guintptr);
...
func (session *AutomationSession) ConnectCreateWebView(f func() (webView *WebView)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(session, "create-web-view", false, unsafe.Pointer(C._gotk4_webkit24_AutomationSession_ConnectCreateWebView), f)
}
...
func (session *AutomationSession) ConnectWillClose(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(session, "will-close", false, unsafe.Pointer(C._gotk4_webkit24_AutomationSession_ConnectWillClose), f)
}
