...
// extern void _gotk4_webkit6_GeolocationManager_ConnectStop(gpointer, guintptr);
// extern gboolean _gotk4_webkit6_GeolocationManager_ConnectStart(gpointer, guintptr);
import "C"
...
func (manager *GeolocationManager) ConnectStart(f func() (ok bool)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(manager, "start", false, unsafe.Pointer(C._gotk4_webkit6_GeolocationManager_ConnectStart), f)
}
...
func (manager *GeolocationManager) ConnectStop(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(manager, "stop", false, unsafe.Pointer(C._gotk4_webkit6_GeolocationManager_ConnectStop), f)
}
