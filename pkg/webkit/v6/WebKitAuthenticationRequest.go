...
// extern void _gotk4_webkit6_AuthenticationRequest_ConnectCancelled(gpointer, guintptr);
// extern void _gotk4_webkit6_AuthenticationRequest_ConnectAuthenticated(gpointer, WebKitCredential*, guintptr);
import "C"
...
func (request *AuthenticationRequest) ConnectAuthenticated(f func(credential *Credential)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(request, "authenticated", false, unsafe.Pointer(C._gotk4_webkit6_AuthenticationRequest_ConnectAuthenticated), f)
}
...
func (request *AuthenticationRequest) ConnectCancelled(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(request, "cancelled", false, unsafe.Pointer(C._gotk4_webkit6_AuthenticationRequest_ConnectCancelled), f)
}
