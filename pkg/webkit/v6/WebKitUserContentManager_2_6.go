...
// extern void _gotk4_webkit6_UserContentManager_ConnectScriptMessageReceived(gpointer, JSCValue*, guintptr);
// extern gboolean _gotk4_webkit6_UserContentManager_ConnectScriptMessageWithReplyReceived(gpointer, JSCValue*, WebKitScriptMessageReply*, guintptr);
import "C"
...
func (manager *UserContentManager) ConnectScriptMessageReceived(f func(value *javascriptcore.Value)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(manager, "script-message-received", false, unsafe.Pointer(C._gotk4_webkit6_UserContentManager_ConnectScriptMessageReceived), f)
}
...
func (manager *UserContentManager) ConnectScriptMessageWithReplyReceived(f func(value *javascriptcore.Value, reply *ScriptMessageReply) (ok bool)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(manager, "script-message-with-reply-received", false, unsafe.Pointer(C._gotk4_webkit6_UserContentManager_ConnectScriptMessageWithReplyReceived), f)
}
...
// RegisterScriptMessageHandler registers a new user script message handler in
// script world.
//
...
func (manager *UserContentManager) RegisterScriptMessageHandler(name, worldName string) bool {
	...
	_cret = C.webkit_user_content_manager_register_script_message_handler(_arg0, _arg1, _arg2)
	runtime.KeepAlive(manager)
...
// handler in script world with name world_name. If NULL is passed as the
// world_name, the default world will be used.
//
...
func (manager *UserContentManager) UnregisterScriptMessageHandler(name, worldName string) {
	...
	C.webkit_user_content_manager_unregister_script_message_handler(_arg0, _arg1, _arg2)
	runtime.KeepAlive(manager)
	runtime.KeepAlive(name)
	runtime.KeepAlive(worldName)
}
