...
// extern void _gotk4_webkit6_FindController_ConnectFoundText(gpointer, guint, guintptr);
// extern void _gotk4_webkit6_FindController_ConnectFailedToFindText(gpointer, guintptr);
// extern void _gotk4_webkit6_FindController_ConnectCountedMatches(gpointer, guint, guintptr);
import "C"
...
func (findController *FindController) ConnectCountedMatches(f func(matchCount uint)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(findController, "counted-matches", false, unsafe.Pointer(C._gotk4_webkit6_FindController_ConnectCountedMatches), f)
}
...
func (findController *FindController) ConnectFailedToFindText(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(findController, "failed-to-find-text", false, unsafe.Pointer(C._gotk4_webkit6_FindController_ConnectFailedToFindText), f)
}
...
func (findController *FindController) ConnectFoundText(f func(matchCount uint)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(findController, "found-text", false, unsafe.Pointer(C._gotk4_webkit6_FindController_ConnectFoundText), f)
}
