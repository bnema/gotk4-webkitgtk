...
// extern void _gotk4_webkit6_PrintOperation_ConnectFinished(gpointer, guintptr);
// extern void _gotk4_webkit6_PrintOperation_ConnectFailed(gpointer, GError*, guintptr);
import "C"
...
func (printOperation *PrintOperation) ConnectFailed(f func(err error)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(printOperation, "failed", false, unsafe.Pointer(C._gotk4_webkit6_PrintOperation_ConnectFailed), f)
}
...
func (printOperation *PrintOperation) ConnectFinished(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(printOperation, "finished", false, unsafe.Pointer(C._gotk4_webkit6_PrintOperation_ConnectFinished), f)
}
