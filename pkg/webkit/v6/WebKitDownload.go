...
// extern void _gotk4_webkit6_Download_ConnectReceivedData(gpointer, guint64, guintptr);
// extern void _gotk4_webkit6_Download_ConnectFinished(gpointer, guintptr);
// extern void _gotk4_webkit6_Download_ConnectFailed(gpointer, GError*, guintptr);
// extern void _gotk4_webkit6_Download_ConnectCreatedDestination(gpointer, gchar*, guintptr);
// extern gboolean _gotk4_webkit6_Download_ConnectDecideDestination(gpointer, gchar*, guintptr);
import "C"
...
func (download *Download) ConnectCreatedDestination(f func(destination string)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(download, "created-destination", false, unsafe.Pointer(C._gotk4_webkit6_Download_ConnectCreatedDestination), f)
}
...
func (download *Download) ConnectDecideDestination(f func(suggestedFilename string) (ok bool)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(download, "decide-destination", false, unsafe.Pointer(C._gotk4_webkit6_Download_ConnectDecideDestination), f)
}
...
func (download *Download) ConnectFailed(f func(err error)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(download, "failed", false, unsafe.Pointer(C._gotk4_webkit6_Download_ConnectFailed), f)
}
...
func (download *Download) ConnectFinished(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(download, "finished", false, unsafe.Pointer(C._gotk4_webkit6_Download_ConnectFinished), f)
}
...
func (download *Download) ConnectReceivedData(f func(dataLength uint64)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(download, "received-data", false, unsafe.Pointer(C._gotk4_webkit6_Download_ConnectReceivedData), f)
}
