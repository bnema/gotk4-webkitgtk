...
// extern void _gotk4_webkit2webextension4_WebFormManager_ConnectWillSubmitForm(gpointer, JSCValue*, WebKitFrame*, WebKitFrame*, guintptr);
// extern void _gotk4_webkit2webextension4_WebFormManager_ConnectWillSendSubmitEvent(gpointer, JSCValue*, WebKitFrame*, WebKitFrame*, guintptr);
import "C"
...
func (v *WebFormManager) ConnectWillSendSubmitEvent(f func(form *javascriptcore.Value, sourceFrame, targetFrame *Frame)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(v, "will-send-submit-event", false, unsafe.Pointer(C._gotk4_webkit2webextension4_WebFormManager_ConnectWillSendSubmitEvent), f)
}
...
func (v *WebFormManager) ConnectWillSubmitForm(f func(form *javascriptcore.Value, sourceFrame, targetFrame *Frame)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(v, "will-submit-form", false, unsafe.Pointer(C._gotk4_webkit2webextension4_WebFormManager_ConnectWillSubmitForm), f)
}
