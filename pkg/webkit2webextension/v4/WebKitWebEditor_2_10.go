...
// extern void _gotk4_webkit2webextension4_WebEditor_ConnectSelectionChanged(gpointer, guintptr);
import "C"
...
func (editor *WebEditor) ConnectSelectionChanged(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(editor, "selection-changed", false, unsafe.Pointer(C._gotk4_webkit2webextension4_WebEditor_ConnectSelectionChanged), f)
}
