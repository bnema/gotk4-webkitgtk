...
// #include <jsc/jsc.h>
// extern void _gotk4_javascriptcore6_WeakValue_ConnectCleared(gpointer, guintptr);
import "C"
...
func (weakValue *WeakValue) ConnectCleared(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(weakValue, "cleared", false, unsafe.Pointer(C._gotk4_javascriptcore6_WeakValue_ConnectCleared), f)
}
