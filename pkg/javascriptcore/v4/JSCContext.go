...
func (context *Context) CheckSyntax(code string, mode CheckSyntaxMode, uri string, lineNumber uint) (*Exception, CheckSyntaxResult) {
	...
	_arg2 = (C.gssize)(len(code))
	_arg1 = (*C.char)(C.calloc(C.size_t((len(code) + 1)), C.size_t(C.sizeof_char)))
	copy(unsafe.Slice((*byte)(unsafe.Pointer(_arg1)), len(code)), code)
...
func (context *Context) Evaluate(code string) *Value {
	var _arg0 *C.JSCContext // out
	var _arg1 *C.char       // out
	var _arg2 C.gssize
...
//   - value representing the last value generated by the script.
func (context *Context) EvaluateInObject(code string, objectInstance unsafe.Pointer, objectClass *Class, uri string, lineNumber uint) (object, value *Value) {
	var _arg0 *C.JSCContext // out
	var _arg1 *C.char       // out
	var _arg2 C.gssize
...
//
//   - value representing the last value generated by the script.
func (context *Context) EvaluateWithSourceURI(code, uri string, lineNumber uint) *Value {
	var _arg0 *C.JSCContext // out
	var _arg1 *C.char       // out
	var _arg2 C.gssize
