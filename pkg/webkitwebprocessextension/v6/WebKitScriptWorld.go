...
// extern void _gotk4_webkitwebprocessextension6_ScriptWorld_ConnectWindowObjectCleared(gpointer, WebKitWebPage*, WebKitFrame*, guintptr);
import "C"
...
func (world *ScriptWorld) ConnectWindowObjectCleared(f func(page *WebPage, frame *Frame)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(world, "window-object-cleared", false, unsafe.Pointer(C._gotk4_webkitwebprocessextension6_ScriptWorld_ConnectWindowObjectCleared), f)
}
